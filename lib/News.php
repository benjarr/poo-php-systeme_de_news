...
class News
{
	...
	/**
	 * Constantes relatives aux erreurs possibles rencontrées lors de l'execution de la méthode.
	 */
	...
	{
		if (!empty($valeurs)) // Si on a spécifié des valeurs, on hydrate l'objet.
		{
	...
	/**
	 * Méthode permettant de savoir si la news est nouvalle.
	 * @return bool
	 */
